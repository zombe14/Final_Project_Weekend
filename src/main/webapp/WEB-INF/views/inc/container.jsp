...
<div class="main_right" id="wingright">
	<ul class="push">
		...
		<li onclick="window.open('${pageContext.request.contextPath}/calendar/calendar','달력','width=850, height=700, scrollbars=yes')"><a href="#"><img alt="포스터  작게" src="./resources/images/home/wing/8월달력.jpeg" width="98" height="125"></a></li>
	</ul>
</div>
</div>
